    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="flex flex-col gap-3">
        {children.map((child) => (
          <div
            key={child.id}
            className="flex items-center gap-4 bg-surface rounded-2xl shadow-sm p-4 hover:ring-2 hover:ring-brand-200 hover:-translate-y-0.5 transition-all duration-150"
          >
            <button
              onClick={() => {
